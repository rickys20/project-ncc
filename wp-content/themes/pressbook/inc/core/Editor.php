...
class Editor implements Serviceable {
	...
	public function load_editor_fonts_css() {
		...
		if ( 'off' !== $lato ) {
			$fonts_css .= ( '.editor-styles-wrapper .editor-post-title .editor-post-title__input,.editor-styles-wrapper h1,.editor-styles-wrapper h2,.editor-styles-wrapper h3,.editor-styles-wrapper h4,.editor-styles-wrapper h5,.editor-styles-wrapper h6{font-family:\'Lato\', Helvetica, Arial, sans-serif;}' );
		}
	...
	public static function heading_font_wgt( $value ) {
		return array(
			'.editor-styles-wrapper .editor-post-title .editor-post-title__input,.editor-styles-wrapper h1,.editor-styles-wrapper h2,.editor-styles-wrapper h3,.editor-styles-wrapper h4,.editor-styles-wrapper h5,.editor-styles-wrapper h6' => array(
				'font-weight' => array(
					'value' => absint( $value ),
				),
			),
