...
EOT;
			wp_enqueue_script( 'recaptcha-api-v3', 'https://www.google.com/recaptcha/api.js?render=' . $grecaptcha_v3_site_key, array(), null );
			wp_add_inline_script( 'recaptcha-api-v3', $script );
		?>
		<input type="hidden" name="g-recaptcha-response" id="<?php echo esc_attr( 'g-recaptcha-response-' . $action ); ?>">
		<?php
		}
	}
