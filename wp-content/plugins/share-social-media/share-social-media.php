<?php
/**
 * Plugin Name: Share Social Media
 * Plugin URI: https://scriptstown.com/wordpress-plugins/share-social-media/
 * Description: Add social media sharing icons to a post or page of your WordPress website and allow visitors to share your content on various social media sites.
 * Version: 1.3.1
 * Author: ScriptsTown
...
define( 'STSSM_PLUGIN_VERSION', '1.3.1' );
